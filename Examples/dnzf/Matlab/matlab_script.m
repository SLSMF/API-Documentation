...
station_ID='dnzf';
sensor='one-sensor';
days_per_page=360; % maximum number of days spanning a page, max 365days
start_date='2022-08-01'; % from date, included in result. Default is 8days in the past, 'YYYY-MM-DD'
end_date='2022-08-30'; % until date, not included in result. Default is day of request 'YYYY-MM-DD'
includesensors='prt';
level_data='true'; % Level data relative to the mean sea level of 30 days.
fit_sample_interval='false'; % Return the stime not corrected by sensor rate.
...
hold on
plot(SL_data_table.Date,SL_data_table.rad-mean(SL_data_table.rad),'r--')
