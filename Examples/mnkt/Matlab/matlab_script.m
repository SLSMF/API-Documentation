...
start_date='2023-01-04'; % from date, included in result. Default is 8days in the past, 'YYYY-MM-DD'
end_date='2023-02-02'; % until date, not included in result. Default is day of request 'YYYY-MM-DD'
includesensors='prs';
...
hold on
plot(SL_data_table.Date,SL_data_table.rad-3.2513,'r--')
